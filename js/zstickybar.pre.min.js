...
var zStickyBar = (function($) {
	...
	function zsb_insertHTML(TARGETELEMENT,CONTENT,REMOVE) {
		var TARGETELEMENT = TARGETELEMENT || '',
			TARGETID = (typeof TARGETELEMENT === 'string') ? TARGETELEMENT.replace(/^#/,'') : '',
			CONTENT = CONTENT || '', REMOVE = REMOVE || false,
			CODE, CONTENTID = CONTENT.replace(/^#/,'');
		TARGETELEMENT = (zsb_checkElement(TARGETELEMENT)) ? TARGETELEMENT : (zsb_checkId(TARGETID)) ? zsb_getId(TARGETID) : '';
...
*/
	...
	function zsb_parseStyleOption(ZSBAO) {
		...
		TOP_BAR_CSS_TEXT = ZSBAO.Top_Bar_CSS_Text || ''+
			...
			'#zsb-bar-base-top,'+
			''+IDBARTOP+'{'+
				''+CSSBDRTEXT+'radius:'+TOP_BAR_BORDER_RADIUS+';'+
			'}'+
			'#zsb-bar-base-top{'+
				'width:'+TOP_BAR_BASE_WIDTH+';'+
				'min-width:'+TOP_BAR_WIDTH+';'+
				''+CSSBKGTEXT+''+CSSCLRTEXT+''+TOP_BAR_BACKGROUND_COLOR+';'+
				''+CSSBKGTEXT+'image:'+TOP_BAR_BACKGROUND_IMAGE+';'+
				'box-shadow:0 0 10px '+TOP_BAR_BOXSHADOW_COLOR+';'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+TOP_BAR_BORDER_COLOR+';'+
			...
			''+IDBARTOP+','+
			''+IDBARTOP+' '+ULCONTENTBOX+'{'+
				''+CSSCLRTEXT+''+TOP_CONTENTBOX_TEXT_COLOR+';'+
			'}'+
			...
			''+IDBARTOP+' '+ULCONTENTBOX+' > li > a{'+
				''+CSSCLRTEXT+''+TOP_CONTENTBOX_LINK_COLOR+';'+
				''+CSSBKGTEXT+''+CSSCLRTEXT+''+TOP_CONTENTBOX_LINK_BACKGROUND_COLOR+';'+
				''+CSSBKGTEXT+'image:'+TOP_CONTENTBOX_LINK_BACKGROUND_IMAGE+';'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+TOP_CONTENTBOX_LINK_BORDER_COLOR+';'+
				''+CSSBDRTEXT+'radius:'+TOP_CONTENTBOX_ITEM_BORDER_RADIUS+';'+
			'}'+
			''+IDBARTOP+' '+ULCONTENTBOX+' > li .zsb-item-base,'+
			''+IDBARTOP+' '+ULCONTENTBOX+' > li .zsb-with-base:before,'+
			''+IDBARTOP+' '+ULCONTENTBOX+' > li > a.zsb-bar-button-hide,'+
			''+IDBARTOP+' a.zsb-bar-button-hide{'+
				''+CSSBDRTEXT+'radius:'+TOP_CONTENTBOX_ITEM_BORDER_RADIUS+';'+
			'}'+
			''+IDBARTOP+' '+ULCONTENTBOX+' > li > a{'+
			...
			''+IDBARTOP+' '+ULCONTENTBOX+' > li > a.zsb-contentbox-item-on{'+
				''+CSSCLRTEXT+''+TOP_CONTENTBOX_LINK_HOVER_COLOR+';'+
				''+CSSBKGTEXT+''+CSSCLRTEXT+''+TOP_CONTENTBOX_LINK_HOVER_BACKGROUND_COLOR+';'+
				''+CSSBKGTEXT+'image:'+TOP_CONTENTBOX_LINK_HOVER_BACKGROUND_IMAGE+';'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+TOP_CONTENTBOX_LINK_HOVER_BORDER_COLOR+';'+
				''+CSSBDRTEXT+'bottom-'+CSSCLRTEXT+''+TOP_CONTENTBOX_LINK_HOVER_BACKGROUND_COLOR+';'+
			'}'+
			''+IDBARTOP+' '+ULMENUBOX+'{'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+TOP_MENUBOX_BORDER_COLOR+';'+
				''+CSSBDRTEXT+'top-'+CSSCLRTEXT+''+TOP_MENUBOX_ACCENT_BORDER_COLOR+';'+
				''+CSSBDRTEXT+'top-width:'+TOP_MENUBOX_ACCENT_BORDER_WIDTH+';'+
				'padding:'+TOP_MENUBOX_PADDING+';'+
			'}'+
			''+IDBARTOP+' li.zsb-menu-popover '+ULMENUBOX+':before{'+
				''+CSSBDRTEXT+'bottom-'+CSSCLRTEXT+''+TOP_MENUBOX_ACCENT_BORDER_COLOR+';'+
			'}'+
			''+IDBARTOP+' li.zsb-menu-popover '+ULMENUBOX+':after{'+
				''+CSSBDRTEXT+'bottom-'+CSSCLRTEXT+''+TOP_MENUBOX_BACKGROUND_COLOR+';'+
			'}'+
			''+IDBARTOP+' .zsb-menubox-base{'+
				''+CSSBKGTEXT+''+CSSCLRTEXT+''+TOP_MENUBOX_BACKGROUND_COLOR+';'+
				''+CSSBKGTEXT+'image:'+TOP_MENUBOX_BACKGROUND_IMAGE+';'+
				'box-shadow:0 2px 10px '+TOP_MENUBOX_BOXSHADOW_COLOR+';'+
				'opacity:'+TOP_MENUBOX_OPACITY+';'+
			'}'+
			''+IDBARTOP+' '+ULMENUBOX+','+
			''+IDBARTOP+' .zsb-menubox-base{'+
				''+CSSBDRTEXT+'radius:'+TOP_MENUBOX_BORDER_RADIUS+';'+
			'}'+
			...
			''+IDBARTOP+' '+ULMENUBOX+' .zsb-menu-table{'+
				''+CSSCLRTEXT+''+TOP_MENUBOX_TEXT_COLOR+';'+
			'}'+
			...
			''+IDBARTOP+' '+ULMENUBOX+' > li .zsb-menu-table a{'+
				''+CSSCLRTEXT+''+TOP_MENUBOX_LINK_COLOR+';'+
				''+CSSBKGTEXT+''+CSSCLRTEXT+''+TOP_MENUBOX_LINK_BACKGROUND_COLOR+';'+
				''+CSSBKGTEXT+'image:'+TOP_MENUBOX_LINK_BACKGROUND_IMAGE+';'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+TOP_MENUBOX_LINK_BORDER_COLOR+';'+
				''+CSSBDRTEXT+'radius:'+TOP_MENUBOX_ITEM_BORDER_RADIUS+';'+
			'}'+
			''+IDBARTOP+' '+ULMENUBOX+' > li .zsb-item-base,'+
			''+IDBARTOP+' '+ULMENUBOX+' > li .zsb-with-base:before{'+
				''+CSSBDRTEXT+'radius:'+BOTTOM_MENUBOX_ITEM_BORDER_RADIUS+';'+
			'}'+
			...
			''+IDBARTOP+' '+ULMENUBOX+' > li > a.zsb-menubox-item-on{'+
				''+CSSCLRTEXT+''+TOP_MENUBOX_LINK_HOVER_COLOR+';'+
				''+CSSBKGTEXT+''+CSSCLRTEXT+''+TOP_MENUBOX_LINK_HOVER_BACKGROUND_COLOR+';'+
				''+CSSBKGTEXT+'image:'+TOP_MENUBOX_LINK_HOVER_BACKGROUND_IMAGE+';'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+TOP_MENUBOX_LINK_HOVER_BORDER_COLOR+';'+
			'}'+
			''+IDBARTOP+' '+ULMENUBOX+' > li.zsb-menu-separator{'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+TOP_MENUBOX_TEXT_COLOR+';'+
			'}'+
		'';
		...
		BOTTOM_BAR_CSS_TEXT = ZSBAO.Bottom_Bar_CSS_Text || ''+
			...
			'#zsb-bar-base-bottom,'+
			''+IDBARBOTTOM+'{'+
				''+CSSBDRTEXT+'radius:'+BOTTOM_BAR_BORDER_RADIUS+';'+
			'}'+
			'#zsb-bar-base-bottom{'+
				'width:'+BOTTOM_BAR_BASE_WIDTH+';'+
				'min-width:'+BOTTOM_BAR_WIDTH+';'+
				''+CSSBKGTEXT+''+CSSCLRTEXT+''+BOTTOM_BAR_BACKGROUND_COLOR+';'+
				''+CSSBKGTEXT+'image:'+BOTTOM_BAR_BACKGROUND_IMAGE+';'+
				'box-shadow:0 0 10px '+BOTTOM_BAR_BOXSHADOW_COLOR+';'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+BOTTOM_BAR_BORDER_COLOR+';'+
			...
			''+IDBARBOTTOM+','+
			''+IDBARBOTTOM+' '+ULCONTENTBOX+'{'+
				''+CSSCLRTEXT+''+BOTTOM_CONTENTBOX_TEXT_COLOR+';'+
			'}'+
			...
			''+IDBARBOTTOM+' '+ULCONTENTBOX+' > li > a{'+
				''+CSSCLRTEXT+''+BOTTOM_CONTENTBOX_LINK_COLOR+';'+
				''+CSSBKGTEXT+''+CSSCLRTEXT+''+BOTTOM_CONTENTBOX_LINK_BACKGROUND_COLOR+';'+
				''+CSSBKGTEXT+'image:'+BOTTOM_CONTENTBOX_LINK_BACKGROUND_IMAGE+';'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+BOTTOM_CONTENTBOX_LINK_BORDER_COLOR+';'+
				''+CSSBDRTEXT+'radius:'+BOTTOM_CONTENTBOX_ITEM_BORDER_RADIUS+';'+
			'}'+
			''+IDBARBOTTOM+' '+ULCONTENTBOX+' > li .zsb-item-base,'+
			''+IDBARBOTTOM+' '+ULCONTENTBOX+' > li .zsb-with-base:before,'+
			''+IDBARBOTTOM+' '+ULCONTENTBOX+' > li > a.zsb-bar-button-hide,'+
			''+IDBARBOTTOM+' a.zsb-bar-button-hide{'+
				''+CSSBDRTEXT+'radius:'+BOTTOM_CONTENTBOX_ITEM_BORDER_RADIUS+';'+
			'}'+
			''+IDBARBOTTOM+' '+ULCONTENTBOX+' > li > a{'+
			...
			''+IDBARBOTTOM+' '+ULCONTENTBOX+' > li > a.zsb-contentbox-item-on{'+
				''+CSSCLRTEXT+''+BOTTOM_CONTENTBOX_LINK_HOVER_COLOR+';'+
				''+CSSBKGTEXT+''+CSSCLRTEXT+''+BOTTOM_CONTENTBOX_LINK_HOVER_BACKGROUND_COLOR+';'+
				''+CSSBKGTEXT+'image:'+BOTTOM_CONTENTBOX_LINK_HOVER_BACKGROUND_IMAGE+';'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+BOTTOM_CONTENTBOX_LINK_HOVER_BORDER_COLOR+';'+
				''+CSSBDRTEXT+'top-'+CSSCLRTEXT+''+BOTTOM_CONTENTBOX_LINK_HOVER_BACKGROUND_COLOR+';'+
			'}'+
			''+IDBARBOTTOM+' '+ULMENUBOX+'{'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+BOTTOM_MENUBOX_BORDER_COLOR+';'+
				''+CSSBDRTEXT+'bottom-'+CSSCLRTEXT+''+BOTTOM_MENUBOX_ACCENT_BORDER_COLOR+';'+
				''+CSSBDRTEXT+'bottom-width:'+BOTTOM_MENUBOX_ACCENT_BORDER_WIDTH+';'+
				'padding:'+BOTTOM_MENUBOX_PADDING+';'+
			'}'+
			''+IDBARBOTTOM+' li.zsb-menu-popover '+ULMENUBOX+':before{'+
				''+CSSBDRTEXT+'top-'+CSSCLRTEXT+''+BOTTOM_MENUBOX_ACCENT_BORDER_COLOR+';'+
			'}'+
			''+IDBARBOTTOM+' li.zsb-menu-popover '+ULMENUBOX+':after{'+
				''+CSSBDRTEXT+'top-'+CSSCLRTEXT+''+BOTTOM_MENUBOX_BACKGROUND_COLOR+';'+
			'}'+
			''+IDBARBOTTOM+' .zsb-menubox-base{'+
				''+CSSBKGTEXT+''+CSSCLRTEXT+''+BOTTOM_MENUBOX_BACKGROUND_COLOR+';'+
				''+CSSBKGTEXT+'image:'+BOTTOM_MENUBOX_BACKGROUND_IMAGE+';'+
				'box-shadow:0 2px 10px '+BOTTOM_MENUBOX_BOXSHADOW_COLOR+';'+
				'opacity:'+BOTTOM_MENUBOX_OPACITY+';'+
			'}'+
			''+IDBARBOTTOM+' '+ULMENUBOX+','+
			''+IDBARBOTTOM+' .zsb-menubox-base{'+
				''+CSSBDRTEXT+'radius:'+BOTTOM_MENUBOX_BORDER_RADIUS+';'+
			'}'+
			...
			''+IDBARBOTTOM+' '+ULMENUBOX+' .zsb-menu-table{'+
				''+CSSCLRTEXT+''+BOTTOM_MENUBOX_TEXT_COLOR+';'+
			'}'+
			...
			''+IDBARBOTTOM+' '+ULMENUBOX+' > li .zsb-menu-table a{'+
				''+CSSCLRTEXT+''+BOTTOM_MENUBOX_LINK_COLOR+';'+
				''+CSSBKGTEXT+''+CSSCLRTEXT+''+BOTTOM_MENUBOX_LINK_BACKGROUND_COLOR+';'+
				''+CSSBKGTEXT+'image:'+BOTTOM_MENUBOX_LINK_BACKGROUND_IMAGE+';'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+BOTTOM_MENUBOX_LINK_BORDER_COLOR+';'+
				''+CSSBDRTEXT+'radius:'+BOTTOM_MENUBOX_ITEM_BORDER_RADIUS+';'+
			'}'+
			...
			''+IDBARBOTTOM+' '+ULMENUBOX+' > li > a.zsb-menubox-item-on{'+
				''+CSSCLRTEXT+''+BOTTOM_MENUBOX_LINK_HOVER_COLOR+';'+
				''+CSSBKGTEXT+''+CSSCLRTEXT+''+BOTTOM_MENUBOX_LINK_HOVER_BACKGROUND_COLOR+';'+
				''+CSSBKGTEXT+'image:'+BOTTOM_MENUBOX_LINK_HOVER_BACKGROUND_IMAGE+';'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+BOTTOM_MENUBOX_LINK_HOVER_BORDER_COLOR+';'+
			'}'+
			''+IDBARBOTTOM+' '+ULMENUBOX+' > li.zsb-menu-separator{'+
				''+CSSBDRTEXT+''+CSSCLRTEXT+''+BOTTOM_MENUBOX_TEXT_COLOR+';'+
			'}'+
		'';
	...
	function zsb_setupFollowbox(){
		...
		if ((ZSB_FACEBOOK_URL_ID) || (ZSB_TWITTER_URL_ID) || (ZSB_GOOGLE_URL_ID) || (ZSB_FEEDBURNER_URL_ID)) {
			if (zsb_checkId('zsb-followbox')) {
				...
				var FOLLOWBOX = zsb_getId('zsb-followbox');
			...
			for (var r = 0, TR; TR = TM.getElementsByTagName('tr')[r]; r++) {
				if (TR.getElementsByTagName('td').length >= 2) {
					var TDL = TR.getElementsByTagName('td').length,
						LASTTD = TR.getElementsByTagName('td')[TDL-1];
	...
	function zsb_setupBarButton() {
		var BarBtnHIDEclsname = 'zsb-bar-button-hide',
			BarBtnSHOWclsname = 'zsb-bar-button-show',
			BarBtnHIDE, BarBtnSHOW;
	...
	function zsb_toggleShowHideBar(POS,SHOWHIDE) {
		var SHOWHIDE = SHOWHIDE || '',
			...
			barBUTTONSHOWsel = '#zsb-bar-button-show-'+POS+'';
		if (SHOWHIDE === 'hide') {
